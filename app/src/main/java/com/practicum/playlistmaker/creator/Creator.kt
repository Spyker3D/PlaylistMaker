...
import com.practicum.playlistmaker.search.domain.interactor.SelectedTrackInteractor
...
object Creator {
    ...
    fun provideSelectedTrackInteractor(): SelectedTrackInteractor {
        return SelectedTrackInteractor(trackStorage = provideStorageRepository())
    }
